...
const (
	// Output file path + file name and line number, e.g. /a/b/c/main.go:123.
	Llongfile uint32 = 1 << iota

	// Only output file file name and line number, e.g.main.go:1  Overrides Llongfile.
	Lshortfile
)
...
// print outputs a log message to the writer.
...
// printf outputs a log message to the writer.
